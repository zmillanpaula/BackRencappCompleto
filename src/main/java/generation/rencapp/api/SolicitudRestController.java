...
public class SolicitudRestController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de todas las solicitudes, obtenidas exitosamente ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Solicitud.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de solicitudes del usuario/vecino obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Solicitud.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Muestra todos los estados de solicitudes creados", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Solicitud.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Edita exitosamente el estado de de una solicitud ya creada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Solicitud.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Crea nueva solicitud para la plantilla del trámite con el id de tramite exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Solicitud.class))),
