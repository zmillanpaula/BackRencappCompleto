...
public class AuthRestController {
    ...
    private final UsuarioUserDetailsServiceImpl usuarioUserDetailsServiceImpl;
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginDTO loginRequest) {
        ...
        UsuarioUserDetailsServiceImpl userDetails = (UsuarioUserDetailsServiceImpl) authentication.getPrincipal();
